    ...
    if should_welc:
        ...
        for new_mem in new_members:
            ...
            if new_mem.id == OWNER_ID:
                update.effective_message.reply_text("My Master Just Joined The Group!Yay I've Super Powers Now!")
                continue
            ...
            # Give start information when add bot to group
                ...
                update.effective_message.reply_text("Thanks For Adding Me Into Your Group. If You Have Any Doubts.. Contact [My Master](t.me/unknown_hacker_x) !")
    ...
    if should_goodbye:
        ...
        if left_mem:
            ...
            if left_mem.id == OWNER_ID:
                update.effective_message.reply_text("My Master Left The Group!Then Why I'm Here? I Too Leave 😥 .")
                return
